...
def forward_kinematics(theta1: float, theta2: float, 
                       L1: float = 0.9, L2: float = 0.9) -> Tuple[float, float]:
    """
...
def jacobian(theta1: float, theta2: float, 
             L1: float = 0.9, L2: float = 0.9) -> np.ndarray:
    """
...
def compute_ds2(theta1: float, theta2: float, 
                ...
                lam: float = 0.02, 
                L1: float = 0.9, 
                L2: float = 0.9) -> Tuple[float, Dict[str, float]]:
    """
...
def compute_gradient(theta1: float, theta2: float, 
                     target: Union[np.ndarray, Tuple[float, float]], 
                     obstacle_center: Union[np.ndarray, Tuple[float, float]], 
                     obstacle_radius: float,
                     Go: float = 4.0, 
                     lam: float = 0.02, 
                     L1: float = 0.9, 
                     L2: float = 0.9) -> Tuple[np.ndarray, float]:
    """
...
def compute_change_stability(delta: Union[np.ndarray, Tuple[float, ...]], 
                             eps_change: float = 1e-3) -> Tuple[int, int, int]:
    """
