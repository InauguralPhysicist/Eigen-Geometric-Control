...
class TestArmSimulation:
    ...
    def test_simulation_columns(self):
        ...
        expected_columns = [
            'tick', 'theta1_rad', 'theta2_rad', 'x', 'y',
            'ds2_total', 'target_term', 'obs_term', 'reg_term',
            'grad_norm', 'C', 'S', 'ds2_CS', 'd_obs',
            'delta_theta1', 'delta_theta2', 'delta_theta_sq'
        ]
    ...
    def test_ds2_decreases(self):
        ...
        assert final_ds2 < initial_ds2, \
            f"ds² should decrease: {initial_ds2:.4f} → {final_ds2:.4f}"
    ...
    def test_obstacle_avoidance(self):
        ...
        assert min_distance > 0.25, \
            f"Violated obstacle boundary: min_distance={min_distance:.4f}m"
...
class TestXORSimulation:
    ...
    def test_xor_columns(self):
        ...
        expected_columns = [
            'tick', 'state_before_hex', 'state_after_hex',
            'axis_hex', 'C', 'S', 'ds2_CS'
        ]
...
class TestReproducibility:
    ...
    def test_xor_reproducibility(self):
        ...
        assert results1['state_before_hex'].equals(results2['state_before_hex']), \
